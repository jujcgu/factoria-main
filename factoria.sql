...
-- Tiempo de generación: 23-09-2021 a las 02:31:00
...
INSERT INTO `ciudad` (`id`, `nombre`, `codigo_postal`, `departamento_id`) VALUES
(1, 'Abriaquí', '1', 5),
(2, 'Acacías', '1', 50),
(3, 'Acandí', '1', 27),
(4, 'Acevedo', '1', 41),
...
(85, 'CASANARE', 52),
(86, 'PUTUMAYO', 52),
(88, 'ARCHIPIÉLAGO DE SAN ANDRÉS Y PROVINCIA', 52),
(91, 'AMAZONAS', 52),
(94, 'GUAINÍA', 52),
(95, 'GUAVIARE', 52),
(97, 'VAUPÉS', 52),
...
(5, 'admin', 'crear, modificar, listar y eliminar todo'),
(6, 'investigador', 'publicar articulo cientifico'),
(7, 'visitante', 'acceder a la informacion de interés y navegar en la plataforma.'),
(8, 'director', 'gestionar la información de un grupo y orientar el mismo.');
